...
<div class="container">
	<form action="modifyOk?type=${bvo.movie_id}&board=${bvo.board_id }&cPage=${cPage}" method="post">
	...
	<table>
		<tbody>
			...
			<tr>
				<td colspan="2">
					<textarea class="box" name="subject" cols="100" title="제목">${bvo.subject }</textarea>
				</td>
			</tr>
		<tr>
			<td class="nickname in l" colspan="2">닉네임</td>
		</tr>
		<tr>
		...
		<tr>
			<td colspan="2">
			<textarea class="box" name="content" rows="20" cols="100" title="내용" required>${bvo.board_content }</textarea>
			</td>
		</tr>
		</tbody>
		<tfoot>
